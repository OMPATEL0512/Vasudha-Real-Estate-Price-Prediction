...
<p align="center">
  <a href="https://github.com/OMPATEL0512/Vasudha-Real-Estate-Price-Prediction">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=00F7FF&center=true&vCenter=true&width=700&lines=AI-Powered+Property+Valuation+Platform;5-Year+Capital+Appreciation+Forecaster;29%2B+Ahmedabad+Micro-Market+Corridors;Live+Email+OTP+Authentication;MongoDB+%2B+SQLite+Hybrid+Failover;R%C2%B2+%3D+0.997+High-Precision+ML+Model"/>
  </a>
</p>

<p align="center">
  <img src="https://img.shields.io/github/stars/OMPATEL0512/Vasudha-Real-Estate-Price-Prediction?style=for-the-badge&color=gold&logo=github" alt="Stars" />
  <img src="https://img.shields.io/github/forks/OMPATEL0512/Vasudha-Real-Estate-Price-Prediction?style=for-the-badge&color=blue&logo=github" alt="Forks" />
  ...
  <img src="https://img.shields.io/badge/MongoDB-Hybrid-47A248?style=for-the-badge&logo=mongodb&logoColor=white" alt="MongoDB" />
...
```mermaid
flowchart TD
    User([👤 Buyer / Investor / Admin])
    
    subgraph Client_Layer ["🖥️ Presentation Layer"]
        WebUI["Modern Web Interface (vasudha-real-estate.html)"]
        StreamlitUI["Interactive Dashboard (app.py)"]
        FlaskUI["Flask REST & UI Server (frontend.py)"]
    end
    
    subgraph Engine_Layer ["🧠 Core Logic & ML Engine"]
        BackendCore["Business Logic & Auth (backend.py)"]
        MLModel["Log-Linear Regression Model (ml_model.py)"]
        CAGREngine["5-Year Compounding Forecaster"]
        EmailDispatcher["SMTP Live OTP Engine"]
    end
    
    subgraph Storage_Layer ["💾 Hybrid Persistence Layer"]
        MongoDB[("🍃 MongoDB (Primary)")]
        SQLite[("🗄️ SQLite (Auto-Failover)")]
    end
    
    User -->|Interacts| Client_Layer
    Client_Layer -->|REST / JSON| Engine_Layer
    Engine_Layer -->|Queries / Persists| Storage_Layer
    Storage_Layer -.->|Fallback to SQLite if Mongo Offline| SQLite
```
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,flask,scikitlearn,mongodb,mysql,js,html,css,git,github,vscode,postman" />
</p>
